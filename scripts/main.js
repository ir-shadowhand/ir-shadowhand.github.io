...
$(function() {
	...
	"Your objective is to travel to @locale and assassinate a group of @sz_group targets. The targets are @group, well known for @bhr_group. In charge is a @behavior @species @cyborg. Be careful, as @cmp_group.<br><br><br>[[Compensation // 1-5 // Mirtis Coins.]]<br><br><br>[[@glt_group of @lvl2]]",
	"Your objective is to travel to @locale and assassinate a group of @sz_group targets. The targets are @group, well known for @bhr_group. In charge is a @behavior @species @cyborg. Be careful, as @cmp_group.<br><br><br>[[Compensation // 6-10 // Mirtis Coins.]]<br><br><br>[[@glt_group of multiple counts of @lvl2]]",
	"Your objective is to travel to @locale and assassinate a group of @sz_group targets. The targets are @group, well known for @bhr_group. In charge is a @behavior @species @cyborg. Be careful, as @cmp_group.<br><br><br>[[Compensation // 11-15 // Mirtis Coins.]]<br><br><br>[[@glt_group @lvl1]]",
	"Your objective is to travel to @locale and assassinate a group of @sz_group targets. The targets are @group, well known for @bhr_group. In charge is a @behavior @species @cyborg. Be careful, as @cmp_group.<br><br><br>[[Compensation // 16-20 // Mirtis Coins.]]<br><br><br>[[@glt_group of multiple counts of @lvl1]]",
